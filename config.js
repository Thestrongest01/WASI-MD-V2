...
global.owner = process.env.OWNER_NUMBER || "237621096195";
...
module.exports = {
  ...
  packname: process.env.PACK_NAME || "Jr",
  botname: process.env.BOT_NAME || "𝐖𝐀𝐒𝐈-𝐌𝐃-𝐕2",
  ownername: process.env.OWNER_NAME || "WASI",
  errorChat: process.env.ERROR_CHAT || "923192173398",
  KOYEB_API: process.env.KOYEB_API || "false",
  REMOVE_BG_KEY: process.env.REMOVE_BG_KEY || "",
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "https://raw.githubusercontent.com/Giftedmaurice/gifted-bot-md-plugins/main/plugins/delete.js",
